      ...
      <div className='container'>
        ...
        <div className='mt-[50px]'>
              ...
              <div>
                ...
                <div className='flex items-center gap-[16px] mt-[14px]'>
                  <div className='flex items-center gap-[6px]'>
                    ...
                    <div className='text-[14px] leading-5 text-[#636A80]'>Australia</div>
                  </div>
                  <div className='flex items-center gap-[4px]'>
                    ...
                    <div className='text-[14px] leading-5 text-[#636A80]'> $120,000 - $140,000</div>
                  </div>
                  <div className='flex items-center gap-[6px]'>
                    <svg
                      width='22'
                    ...
                    <div className='text-[14px] leading-5 text-[#636A80]'>4 Days Remaining</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div
            ...
            cursor-pointer rounded-[12px] hover:shadow-2xl hover:transition hover:ease-in-out
            hover:duration-[0.25s] mt-[24px]'
          >
            <div className='flex items-center gap-[20px]'>
              <img
                src='src/assets/images/tiktok.png'
