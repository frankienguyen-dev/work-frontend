      ...
      <div className='container'>
        <div className='py-[100px]'>
          <div className='flex items-center justify-between'>
            <h1 className='text-[40px] font-medium leading-[48px] text-[#18191C]'>Popular Category</h1>
              ...
              {categoryListData &&
                ...
                hover:ease-in-out hover:duration-[0.25s] h-[116px]'
                    ...
                    items-center justify-center'
                        ...
                        <div>
                          <h3 className='text-[18px] leading-7 font-medium text-[#18191C]'>{category.name}</h3>
                          <p className='text-[14px] leading-5 text-[#5E6670] mt-[8px]'>
                            {category.jobs && category.jobs.length > 0
                              ? category.jobs.length > 1
                                ? category.jobs.length + ' Open positions'
