...
export default function ModalUpdateStatusResume({ closeModal, resumeId }: Props) {
  ...
  console.log('check resume data: ', resumeDataById);
    ...
    updateStatusResumeMutation.mutate(updateResumeData, {
      onSuccess: (data) => {
        queryClient
          ...
          .then();
        toast.success('Update status resume success! 🎉');
