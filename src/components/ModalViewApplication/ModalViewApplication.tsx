              ...
              <div className='pt-[8px] px-[48px] pb-[48px]'>
                <div className='flex items-center justify-between '>
                  <div className='flex items-center gap-x-[24px]'>
                    <img
                      src={getLogoUrl(applicationDataDetail?.avatar?.fileName)}
                      alt=''
                      className='w-[80px] h-[80px] object-cover rounded-full'
                    />
                    <div className='flex flex-col gap-y-[8px]'>
                      <div className='text-[24px] leading-8 font-medium text-[#18191C]'>
                        {applicationDataDetail?.fullName}
                      </div>
                      <div className='text-[16px] leading-6 text-[#767F8C]'>{applicationDataDetail?.title}</div>
                    </div>
                  </div>
                  ...
                  <div className='grid grid-cols-12 gap-x-[72px]'>
                    <div className='col-span-7'>
                      ...
                      <div className='mt-[24px] text-[16px] leading-6 text-[#5E6670]'>
                        {applicationDataDetail?.biography}
                      </div>
                      <div className='h-[1px] bg-[#E4E5E8] my-[32px]'></div>
                      <div>COVER LETTER</div>
                      <div className='mt-[24px] text-[16px] leading-6 text-[#5E6670]'>
                        {applicationDataDetail?.coverLetter}
                      </div>
                    </div>
                    <div className='col-span-5'>
                        ...
                        <div className='p-[24px] grid grid-cols-2 gap-x-[16px] gap-y-[24px]'>
                          <div className='col-span-1'>
                            ...
                            <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191C]'>
                              {applicationDataDetail?.age} Years Old
                            </div>
                          </div>
                          <div className='col-span-1'>
                            <div>
                          ...
                          <div className='col-span-1'>
                            ...
                            <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191C]'>
                              {Number(applicationDataDetail?.experience) > 1
                                ? applicationDataDetail?.experience + ' Years'
                                : applicationDataDetail?.experience + ' Year'}
                            </div>
                          </div>
                          <div className='col-span-1'>
                            <div>
                            ...
                            <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191C]'>
                              {applicationDataDetail?.education}
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className='mt-[24px] border-[2px] rounded-[8px] border-[#E7F0FA] p-[24px]'>
                        ...
                        <div className='mt-[16px] flex items-center justify-between gap-x-[72px]'>
                          ...
                          <button
                            type='button'
                            onClick={(event) => handleDownloadResume(event)}
                      ...
                      <div className='mt-[24px] border-[2px] rounded-[8px] border-[#E7F0FA] p-[24px]'>
                        ...
                        <div className='mt-[24px] flex items-center gap-x-[16px]'>
                          ...
                          <div className='flex flex-col gap-y-[4px]'>
                            ...
                            <div className='text-[14px] font-medium leading-5 text-[#18191C]'>
                              {applicationDataDetail?.address}
                            </div>
                          </div>
                        </div>
                        ...
                        <div className='mt-[24px] flex items-center gap-x-[16px]'>
                          ...
                          <div>
                            <div className='flex flex-col gap-y-[4px]'>
                              ...
                              <div className='text-[14px] font-medium leading-5 text-[#18191C]'>
                                {applicationDataDetail?.phoneNumber}
                              </div>
                            </div>
                          </div>
                        </div>
