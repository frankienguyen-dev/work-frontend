        ...
        <div className='py-[100px]'>
          ...
          <div className='mt-[50px]'>
            <div className='grid grid-cols-4 gap-[24px]'>
              <Link to='/'>
                <div
                  className='bg-white p-8 border border-[#EDEFF5] rounded-[12px]
                ...
                >
                  <div className='flex items-center gap-[16px]'>
                    ...
                    />
                    <div>
                      <h3 className='text-[18px] text-[#191F33] font-medium leading-7'>Tiktok</h3>
                      <div className='flex mt-[6px] gap-[6px] items-center'>
                        ...
                        <div className='text-[14px] leading-5 text-[#939AAD]'>United States</div>
                      </div>
                    </div>
                  </div>
