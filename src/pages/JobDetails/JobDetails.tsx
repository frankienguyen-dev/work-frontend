...
import { Job } from '../../types/job.type.ts';
...
export default function JobDetails() {
  ...
  const { data: jobDetailData, isLoading } = useQuery({
          ...
          <div className='container'>
                ...
                <div>
                  ...
                  <div className='flex items-center gap-[20px] mt-[13px]'>
                    <div className='flex items-center gap-[8px]'>
                      ...
                      <div className='text-[16px] leading-6 text-[#474c54]'>{job.company.website}</div>
                    </div>
                    <div className='flex items-center gap-[6px]'>
                      ...
                      <div className='text-[16px] leading-6 text-[#474c54]'>{job.company.phoneNumber}</div>
                    </div>
                    <div className='flex items-center gap-[6px]'>
                      <div>
                        <svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
            ...
            <div className='grid grid-cols-12 gap-[50px] mb-[28px]'>
              <div className='col-span-7'>
                ...
                <div className='mt-[32px] text-[18px] font-medium leading-7 text-[#000000]'>Responsibilities</div>
                <div
                  ...
                  <div className='grid grid-cols-3 gap-x-[20px] gap-y-[24px] mt-[24px]'>
                    ...
                    <div className='col-span-1'>
                      ...
                      <div className='mt-[16px]'>
                        ...
                        <div className='mt-[4px] text-[14px] leading-5 font-medium text-[#18191c]'>{job.education}</div>
                      </div>
                    </div>
                    <div className='col-span-1'>
                      <div>
                    ...
                    <div className='col-span-1'>
                      ...
                      <div className='mt-[16px]'>
                        ...
                        <div className='mt-[4px] text-[14px] leading-5 font-medium text-[#18191c]'>{job.location}</div>
                      </div>
                    </div>
                    <div className='col-span-1'>
                      <div>
                      ...
                      <div className='mt-[16px]'>
                        ...
                        <div className='mt-[4px] text-[14px] leading-5 font-medium text-[#18191c]'>{job.jobType}</div>
                      </div>
                    </div>
                    <div className='col-span-1'>
                      <div>
                ...
                <div className='mt-[24px] p-[32px] w-full border-[2px] solid border-[#e7f0fa] rounded-[8px]'>
                  ...
                  <div className='mt-[32px]'>
                    ...
                    <div className='flex items-center justify-between mt-[16px]'>
                      ...
                      <div className='text-[16px] leading-6 text-[#18191c]'>{job.company.teamSize} Employers</div>
                    </div>
                    <div className='flex items-center justify-between mt-[16px]'>
                      <div className='text-[16px] leading-6 text-[#5e6670]'>Phone:</div>
                      <div className='text-[16px] leading-6 text-[#18191c]'>{job.company.phoneNumber}</div>
                    </div>
                    <div className='flex items-center justify-between mt-[16px]'>
                    ...
                    <div className='flex items-center justify-between mt-[16px]'>
                      ...
                      <div className='text-[16px] leading-6 text-[#18191c]'>{job.company.website}</div>
                    </div>
                  </div>
                </div>
              </div>
