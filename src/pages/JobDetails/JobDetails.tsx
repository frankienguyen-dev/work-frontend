        ...
        <div className='my-[32px] flex items-center justify-between'>
            ...
            <div>
              ...
              <div className='flex items-center gap-[20px] mt-[13px]'>
                <div className='flex items-center gap-[8px]'>
                  ...
                  <div className='text-[16px] leading-6 text-[#474c54]'>https://instagram.com</div>
                </div>
                <div className='flex items-center gap-[6px]'>
                  ...
                  <div className='text-[16px] leading-6 text-[#474c54]'>(406) 555-0120</div>
                </div>
                <div className='flex items-center gap-[6px]'>
                  <div>
                    <svg
                  ...
                  <div className='text-[16px] leading-6 text-[#474c54]'>career@instagram.com</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-[12px]'>
            ...
            <div className='flex justify-end gap-[8px]'>
              ...
              <div className='text-[14px] leading-5 text-[#e05150] font-medium'> June 30, 2024</div>
            </div>
          </div>
        </div>
        <div className='grid grid-cols-12 gap-[50px] mb-[28px]'>
          <div className='col-span-7'>
            <div className='text-[18px] font-medium leading-7 text-[#000000]'>Job Description</div>
            <div className='mt-[16px]'>
              ...
              <div className='mt-[16px] text-[16px] leading-6 text-[#5e6670] w-[734px] break-all'>
            ...
            <div className='mt-[16px]'>
              <ul>
                <li className='text-[16px] leading-6 text-[#5e6670]'>
                  Quisque semper gravida est et consectetur.
                </li>
                <li className='text-[16px] leading-6 text-[#5e6670] mt-[16px]'>
                ...
                <li className='text-[16px] leading-6 text-[#5e6670] mt-[16px]'>
                  Curabitur eu vehicula libero. Vestibulum sed purus ullamcorper, lobortis lectus
                  nec.
                </li>
                <li className='text-[16px] leading-6 text-[#5e6670] mt-[16px]'>
          ...
          <div className='col-span-5'>
            <div className='p-[32px] w-full  h-[438px] border-[2px] solid border-[#e7f0fa] rounded-[8px]'>
              ...
              <div className='grid grid-cols-3 gap-[20px] mt-[24px]'>
                ...
                <div className='col-span-1'>
                  ...
                  <div className='mt-[16px]'>
                    <div className='text-[12px] leading-[18px] text-[#767f8c]'>JOB EXPIRE IN:</div>
                    <div className='mt-[4px] text-[14px] leading-5 font-medium text-[#18191c]'>
                      14 June, 2024
                    </div>
                  </div>
            ...
            <div
              className='mt-[24px] p-[32px] w-full  h-[438px] border-[2px] solid border-[#e7f0fa]
            rounded-[8px]'
            >
              <div className='flex items-center gap-[16px]'>
                ...
                <div>
                  <div className='text-[20px] text-[#18191c] font-medium leading-8'>Instagram</div>
              ...
              <div className='mt-[32px]'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='text-[16px] leading-6 text-[#18191c]'>March 21, 2006</div>
                </div>
                <div className='flex items-center justify-between mt-[16px]'>
                  <div className='text-[16px] leading-6 text-[#5e6670]'>Company size:</div>
                  <div className='text-[16px] leading-6 text-[#18191c]'>120-300 Employers</div>
                </div>
                <div className='flex items-center justify-between mt-[16px]'>
                  <div className='text-[16px] leading-6 text-[#5e6670]'>Phone:</div>
                  <div className='text-[16px] leading-6 text-[#18191c]'>(406) 555-0120</div>
                </div>
                <div className='flex items-center justify-between mt-[16px]'>
                  <div className='text-[16px] leading-6 text-[#5e6670]'>Email:</div>
                  <div className='text-[16px] leading-6 text-[#18191c]'>twitter@gmail.com</div>
                </div>
                <div className='flex items-center justify-between mt-[16px]'>
                  <div className='text-[16px] leading-6 text-[#5e6670]'>Website:</div>
                  <div className='text-[16px] leading-6 text-[#18191c]'>https://twitter.com</div>
                </div>
              </div>
            </div>
          </div>
