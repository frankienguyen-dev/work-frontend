...
const custom: CustomFlowbiteTheme = {
  dropdown: {
    floating: {
      item: {
        base:
          'flex items-center justify-start py-2 px-4 text-sm text-[#5E6670] cursor-pointer ' +
    ...
    <div className='mt-[40px]'>
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-[8px]'>
          ...
          <div className='text-[20px] font-medium leading-8 text-[#9199a3]'>(123)</div>
        </div>
        <div>
          <select
         ...
         hover:outline hover:outline-[#0b65cc] hover:rounded-[8px] border-b border-b-[#e4e5e8] solid'
          >
            <div className='col-span-4'>
              <div className='text-[16px] font-medium leading-6 text-[#18191c]'>UI/UX Designer</div>
              <div className='relative flex gap-[10px] items-center mt-2'>
                <div className='text-[14px] leading-5 text-[#767f8c]'>Full Time</div>
                <div className='w-[4px] h-[4px] bg-red-700 rounded-[4px]'></div>
                <div className='text-[14px] leading-5 text-[#767f8c]'>27 days remaining</div>
              </div>
            </div>
            ...
            <div className='col-span-3 flex justify-center'>
              <div className='flex items-center gap-[8px]'>
                ...
                hover:cursor-pointer transition duration-[0.25s] ease-in-out'
                >
