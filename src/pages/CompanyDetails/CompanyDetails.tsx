...
export default function CompanyDetails() {
  ...
  const { data: companyDetailData, isLoading } = useQuery({
              ...
              <div className='grid grid-cols-12 gap-[60px] mt-[128px] mb-[28pxpx]'>
                <div className='col-span-7'>
                  ...
                  <div className='mt-[36px]'>
                    <div className='text-[20px] text-[#18191c] leading-8 font-medium'>Company Benefits</div>
                ...
                <div className='col-span-5'>
                  <div className='p-[32px] h-[268px] border-[2px] solid border-[#e7f0fa] rounded-[12px]'>
                    <div className='grid grid-cols-2 gap-x-[20px] gap-y-[24px]'>
                      <div className='col-span-1'>
                        ...
                        <div className='mt-[16px] text-[12px] leading-[18px] text-[#767f8c]'>FOUNDED IN</div>
                      ...
                      <div className='col-span-1'>
                        ...
                        <div className='mt-[16px] text-[12px] leading-[18px] text-[#767f8c]'>LOCATION</div>
                        <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191c]'>
                          {company.address}
                        </div>
                      </div>
                      <div className='col-span-1'>
                        ...
                        <div className='mt-[16px] text-[12px] leading-[18px] text-[#767f8c]'>TEAM SIZE</div>
                        <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191c]'>
                      ...
                      <div className='col-span-1'>
                        ...
                        <div className='mt-[16px] text-[12px] leading-[18px] text-[#767f8c]'>INDUSTRY TYPES</div>
                        <div className='mt-[4px] text-[14px] font-medium leading-5 text-[#18191c]'>
                          {company.companyType}
                        </div>
                      </div>
                  ...
                  <div className='mt-[24px] p-[32px] border-[2px] solid border-[#e7f0fa] rounded-[12px] h-[354px]'>
                    <div className='grid grid-cols-1 gap-y-[24px]'>
                      <div className='col-span-1'>
                        <div className='text-[20px] leading-8 font-medium text-[#18191C]'>Contact Information</div>
                      </div>
                      <div className='col-span-1'>
