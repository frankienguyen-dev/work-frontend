import banner from 'src/assets/images/banner-company.jpeg';
          ...
          <div className='bg-white rounded-[12px] h-[160px] p-[40px] border solid border-[#e4e5e8]'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-[24px]'>
                ...
                <div>
                  <div className='text-[24px] leading-8 font-medium text-[#18191c]'>Instagram</div>
          ...
          <div className='col-span-7'>
            <div>
              ...
              <div className='mt-[16px] text-[16px] leading-6 text-[#5e6670]'>
                Fusce et erat at nibh maximus fermentum. Mauris ac justo nibh. Praesent nec lorem
                lorem. Donec ullamcorper lacus mollis tortor pretium malesuada. In quis porta nisi,
                quis fringilla orci. Donec porttitor, odio a efficitur blandit, orci nisl porta
                elit, eget vulputate quam nibh ut tellus. Sed ut posuere risus, vitae commodo velit.
                Nullam in lorem dolor. Class aptent taciti sociosqu ad litora torquent per conubia
                nostra, per inceptos himenaeos. Vestibulum ante ipsum primis in faucibus orci luctus
                et ultrices posuere cubilia curae; Nulla tincidunt ac quam quis vehicula. Quisque
                sagittis ullamcorper magna. Vivamus elementum eu leo et gravida. Sed dignissim
                placerat diam, ac laoreet eros rutrum sit amet. Donec imperdiet in leo et imperdiet.
                In hac habitasse platea dictumst. Sed quis nisl molestie diam ullamcorper
                condimentum. Sed aliquet, arcu eget pretium bibendum, odio enim rutrum arcu, quis
                suscipit mauris turpis in neque. Vestibulum id vestibulum odio. Sed dolor felis,
                iaculis eget turpis eu, lobortis imperdiet massa.
              </div>
            </div>
            <div className='mt-[36px]'>
              ...
              <div className='mt-[16px]'>
                <div className='mt-[16px] text-[16px] leading-6 text-[#5e6670]'>
                  Donec dignissim nunc eu tellus malesuada fermentum. Sed blandit in magna at
                  accumsan. Etiam imperdiet massa aliquam, consectetur leo in, auctor neque.
                </div>
                <ul>
                  <li className='text-[16px] leading-6 text-[#5e6670] mt-[12px]'>
            ...
            <div className='mt-[36px]'>
              <div className='text-[20px] text-[#18191c] leading-8 font-medium'>Company Vision</div>
              <div className='mt-[16px] text-[16px] leading-6 text-[#5e6670]'>
                Praesent ultrices mauris at nisi euismod, ut venenatis augue blandit. Etiam massa
                risus, accumsan nec tempus nec, venenatis in nisl. Maecenas nulla ex, blandit in
                magna id, pellentesque facilisis sapien. In feugiat auctor mi, eget commodo lectus
                convallis ac.
              </div>
            </div>
          </div>
