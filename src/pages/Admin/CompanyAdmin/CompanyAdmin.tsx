...
import ModalUpdateCompany from './ModalCompany/ModalUpdateCompany';

type FormData = Pick<Schema, 'name'>;
const searchCompanyAdminSchema = schema.pick(['name']);
export default function CompanyAdmin() {
  ...
  const pageNo = Number(queryConfigCompanyAdmin.pageNo);
  const pageSize = Number(queryConfigCompanyAdmin.pageSize);
  ...
  const companies = companyListData?.data.data.data;
  const metaData = companyListData?.data.data.meta;
  const totalPagesData = Number(metaData?.totalPages as number);
  ...
  return (
    <div className='my-[54px]'>
      <div className='text-[18px] leading-7 font-medium text-[#18191c]'>Companies</div>
      ...
      <div className='mt-[24px]'>
        <div className='grid grid-cols-12 bg-[#f1f2f4] px-[20px] py-[10px] rounded-[4px]'>
          ...
          <div className='col-span-3 text-[12px] text-[#535860]'>Address</div>
          <div className='col-span-2 text-[12px] text-[#535860]'>Created At</div>
          <div className='col-span-2 text-[12px] text-[#535860]'>Updated At</div>
        ...
        {loadingCompanyList ? (
          ...
          hover:cursor-pointer hover:outline outline-[#0b65cc] rounded-[8px] '
              >
                ...
                <div className='col-span-3 text-[16px] text-[#535860]'>{company.name}</div>
                <div className='col-span-3 text-[16px] text-[#535860]'>{company.address}</div>
                <div className='col-span-2  text-[16px] text-[#535860]'>
                  {moment(company.createdAt).format('DD MMM, YYYY')}
                </div>
                <div className='col-span-2 text-[16px] text-[#535860]'>
                  {' '}
                  {moment(company.updatedAt).format('DD MMM, YYYY')}
                </div>
                <div
            ...
            items-center gap-[6px]'
                >
                  <button
                    ...
                    onClick={(event) => handleButtonEditClicked(event, company.id)}
                  >
                    <svg
