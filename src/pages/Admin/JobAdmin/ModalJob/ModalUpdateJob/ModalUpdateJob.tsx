...
export default function ModalUpdateJob({ closeModal, jobId }: Props) {
  ...
  const {
    ...
    resolver: yupResolver(formJobSchema),
    defaultValues: {
      name: '',
      location: '',
      quantity: 0,
  ...
  console.log('check category: ', categoryListData);
  const onSubmit = handleSubmit((data) => {
    ...
    console.log('checkdata update: ', updateJobData);
  ...
  useEffect(() => {
    if (jobInfo) {
      ...
      setValue('quantity', jobInfo.quantity);
      setValue('level', jobInfo.level);
      setValue('salary', jobInfo.salary);
      setValue('startDate', jobInfo.startDate ? new Date(jobInfo.startDate) : new Date());
      setValue('endDate', jobInfo.endDate ? new Date(jobInfo.endDate) : new Date());
      setValue('education', jobInfo.education);
      setValue('experience', jobInfo.experience);
      ...
      setValue('category', jobInfo.category.id);
    }
                ...
                <div className='col-span-4'>
                  ...
                  <div>
                    <CalendarJobAdmin
                      ...
                      startDate={jobInfo?.startDate && new Date(jobInfo?.startDate)}
                    />
                  </div>
                </div>
                <div className='col-span-4'>
                  ...
                  <div>
                    <CalendarJobAdmin
                      ...
                      endDate={jobInfo?.endDate ? new Date(jobInfo?.endDate) : new Date()}
                    />
                  </div>
                </div>
              </div>
          ...
          text-[16px] leading-6 text-[#111827]'
                  ...
                  <div className='col-span-3'>
                    ...
                    <AutoCompleteSearchInput
                      ...
                      companyNameFromServer={jobInfo?.company?.name}
                    />
                  </div>
                </div>
                <div className='grid grid-cols-12 gap-[18px] mt-[18px]'>
                  <div className='col-span-12'>
                    ...
                    <TagInputComponent
                      ...
                      name='skills'
                      setValue={setValue}
                      skillsFormServer={jobInfo?.skills}
                    />
                    <div className='mt-1 min-h-[1.25rem] text-sm text-red-600 dark:text-red-500'>
