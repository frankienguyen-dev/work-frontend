            ...
            <Link
              ...
              className={classNames(
                'flex items-center gap-[16px] pl-[20px] py-[16px] group-hover:bg-[#E7F0FA]\n' +
                  ...
                  ' group-hover:translate-y-0',
                {
                  'border-l-[#0b65cc] bg-[#E7F0FA] ': location.pathname === '/admin/invitation',
                  'border-l-transparent': location.pathname !== '/admin/invitation'
                }
              )}
            >
              <div>
                <svg
                  className={classNames('group-hover:stroke-[#0b65cc]', {
                    'text-[#0b65cc]': location.pathname === '/admin/invitation',
                    '': location.pathname !== '/admin/invitation'
                  })}
                  width='24'
                  height='24'
                  viewBox='0 0 24 24'
              ...
              <div
                className={classNames('text-[16px] font-medium group-hover:text-[currentTextColor]', {
                  'text-[#0b65cc]': location.pathname === '/admin/invitation',
                  'text-[currentColor]': location.pathname !== '/admin/invitation'
                })}
              >
                Invitations
              </div>
